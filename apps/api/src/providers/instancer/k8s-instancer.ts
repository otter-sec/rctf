  ...
  .catchall(
    z.object({
      ...
      protocol: z
        ...
        .check(z.describe('Service protocol')),
      port: z.int32()
        .check(z.gte(1), z.lte(65535), z.describe('Service port')),
      targetPort: z
        .optional(
          z.union([
            z.int32()
...
const resourceListSchema = z
  .catchall(
    z.object({
      cpu: z
        .optional(z.string())
        .check(z.describe('CPU')),
      memory: z
        .optional(z.string())
        .check(z.describe('Memory')),
    }),
    z.any(),
  )
...
const resourcesSchema = z
  .catchall(
    z.object({
      limits: z
        .optional(resourceListSchema)
        .check(z.describe('Limits')),
      requests: z
        .optional(resourceListSchema)
        .check(z.describe('Requests')),
    }),
    z.any(),
  )
  ...
  .catchall(
    z.object({
        ...
        .optional(
          z.object({
            add: z
              ...
              .check(z.describe('Add')),
            drop: z
              .optional(z.array(z.string()))
              .check(z.describe('Drop')),
          })
        )
        .check(z.describe('Capabilities')),
      privileged: z.prefault(
        z
          .optional(z.boolean()),
        false,
      )
      ...
      runAsNonRoot: z.prefault(
        z
          .optional(z.boolean())
          .check(z.describe('Run as non root')),
        false,
      ),
      readOnlyRootFilesystem: z.prefault(
        z
          .optional(z.boolean()),
        false,
      )
        .check(z.describe('Read only root filesystem')),
      allowPrivilegeEscalation: z.prefault(
        z
          .optional(z.boolean()),
        false,
      )
...
const httpGetActionSchema = z
  .catchall(
    z.object({
      ...
      scheme: z
        .optional(z.enum(['HTTP', 'HTTPS']))
        .check(z.describe('Scheme')),
      httpHeaders: z
        .optional(
          z.array(
            z.object({
...
const probeSchema = z
  .catchall(
    z.object({
      ...
      exec: z
        .optional(execActionSchema)
        .check(z.describe('Execute')),
      httpGet: z
        .optional(httpGetActionSchema)
        .check(z.describe('HTTP GET')),
      tcpSocket: z
...
const volumeMountSchema = z
  .catchall(
    z.object({
      name: z
        .string()
        .check(z.minLength(1), z.describe('Name')),
      readOnly: z
        .prefault(
          z.boolean(),
          false,
        )
        .check(z.describe('Read only')),
      mountPath: z
        .string()
        .check(z.minLength(1), z.describe('Mount path')),
      subPath: z
        .optional(
          z.string()
            .check(z.minLength(1)),
...
const containerSchema = z
  .catchall(
    z.object({
      ...
      image: z
        .string()
        .check(z.minLength(1), z.describe('Image')),
      command: z
        .optional(
          z.array(z.string()),
        )
      ...
      ports: z
        .optional(z.array(containerPortSchema))
        .check(z.describe('Ports')),
      env: z
        .optional(z.array(envVarSchema))
        .check(z.describe('Env')),
      resources: z
        .optional(resourcesSchema)
        .check(z.describe('Resources')),
      restartPolicy: z
      ...
      livenessProbe: z
        ...
        .check(z.describe('Liveness probe')),
      readinessProbe: z
        .optional(probeSchema)
        ...
        .optional(
          z.catchall(
            z.object({
              ...
              type: z.optional(
                z.prefault(
                  z.enum(['', 'DirectoryOrCreate', 'Directory', 'FileOrCreate', 'File', 'Socket', 'CharDevice', 'BlockDevice']),
                  '',
                ),
              ),
            }),
        ...
        .optional(
          z.catchall(
            z.object({
              ...
              medium: z.prefault(
                  z.enum(['', 'Memory', 'HugePages', 'HugePages-']),
                '',
                )
                .check(z.describe('Medium')),
              sizeLimit: z
                .optional(z.string())
                .check(z.describe('Size limit')),
            }),
            z.any(),
          ),
        )
...
const podSpecSchema = z
  .catchall(
    z.object({
      volumes: z
        .optional(z.array(volumeSchema))
        .check(z.describe('Volumes')),
      initContainers: z
      ...
      dnsConfig: z
        .optional(dnsConfigSchema)
        .check(z.describe('DNS config')),
      resources: z
        .optional(resourcesSchema)
        .check(z.describe('Resources')),
    }),
...
const podSchema = z
  .object({
    name: z
      ...
      .check(z.describe('Name')),
    ports: z
      .array(servicePortSchema)
      .check(z.describe('Ports')),
    spec: podSpecSchema
      .check(z.describe('Pod spec')),
    egress: z
      .optional(z.boolean())
      .check(z.describe('Egress')),
  })
