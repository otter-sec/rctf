...
{#snippet categoryIcon(
  ...
  >
    {#if showLabel}
      ...
      <span class="text-category-foreground-l1 truncate capitalize">{config.name}</span>
    {:else}
      <Tooltip.Root>
...
{:else}
  <div class="bg-background-l0 sticky top-0 z-20 flex">
    <div
      class="bg-background-l0 sticky left-0 z-30 shrink-0 pr-2"
