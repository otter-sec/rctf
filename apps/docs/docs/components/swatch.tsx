...
const colors: Record<string, string> = {
  ...
  'background-l0': 'oklch(98% 0 0)',
  'background-l1': 'oklch(95% 0 0)',
  'background-l2': 'oklch(93% 0 0)',
  'background-l3': 'oklch(91% 0 0)',
  'background-l4': 'oklch(89% 0 0)',
  'background-l5': 'oklch(84% 0 0)',
  'background-l0-dark': 'oklch(15% 0 0)',
  'background-l1-dark': 'oklch(18.5% 0 0)',
  'background-l2-dark': 'oklch(22% 0 0)',
  'background-l3-dark': 'oklch(26% 0 0)',
  'background-l4-dark': 'oklch(30% 0 0)',
  'background-l5-dark': 'oklch(40% 0 0)',

  'foreground-l0': 'oklch(37.1% 0 0)', // neutral-700
  'foreground-l1': 'oklch(43.9% 0 0)', // neutral-600
  'foreground-l2': 'oklch(55.6% 0 0)', // neutral-500
  'foreground-l3': 'oklch(60% 0 0)',
  'foreground-l4': 'oklch(65% 0 0)',
  'foreground-l5': 'oklch(70% 0 0)',
  'foreground-l0-dark': 'oklch(98.5% 0 0)', // neutral-50
  'foreground-l1-dark': 'oklch(92.2% 0 0)', // neutral-200
  'foreground-l2-dark': 'oklch(87% 0 0)', // neutral-300
  'foreground-l3-dark': 'oklch(70.8% 0 0)', // neutral-400
  'foreground-l4-dark': 'oklch(59.7% 0 0)',
  'foreground-l5-dark': 'oklch(55.6% 0 0)', // neutral-500

  'background-accent': `color-mix(in oklch, ${tailwind['sky-200']} 50%, transparent)`,
  'background-accent-hover': `color-mix(in oklch, ${tailwind['sky-200']} 70%, transparent)`,
  'foreground-accent': tailwind['sky-700'],
  'background-accent-dark': `color-mix(in oklch, ${tailwind['sky-800']} 30%, transparent)`,
  'background-accent-hover-dark': `color-mix(in oklch, ${tailwind['sky-800']} 50%, transparent)`,
  'foreground-accent-dark': tailwind['sky-300'],

  'background-gold': `color-mix(in oklch, ${tailwind['yellow-500']} 15%, transparent)`,
  'foreground-gold-l0': tailwind['yellow-600'],
  'foreground-gold-l1': `color-mix(in oklch, ${tailwind['yellow-600']} 70%, transparent)`,
  'background-gold-dark': `color-mix(in oklch, ${tailwind['yellow-950']} 20%, transparent)`,
  'foreground-gold-l0-dark': tailwind['yellow-400'],
  'foreground-gold-l1-dark': tailwind['yellow-700'],

  'background-silver': `color-mix(in oklch, ${tailwind['slate-400']} 20%, transparent)`,
  'foreground-silver-l0': tailwind['slate-600'],
  'foreground-silver-l1': `color-mix(in oklch, ${tailwind['slate-600']} 70%, transparent)`,
  'background-silver-dark': `color-mix(in oklch, ${tailwind['slate-700']} 20%, transparent)`,
  'foreground-silver-l0-dark': tailwind['slate-300'],
  'foreground-silver-l1-dark': tailwind['slate-500'],

  'background-bronze': `color-mix(in oklch, ${tailwind['amber-800']} 10%, transparent)`,
  'foreground-bronze-l0': tailwind['amber-800'],
  'foreground-bronze-l1': `color-mix(in oklch, ${tailwind['amber-800']} 70%, transparent)`,
  'background-bronze-dark': `color-mix(in oklch, ${tailwind['amber-950']} 20%, transparent)`,
  'foreground-bronze-l0-dark': tailwind['amber-500'],
  'foreground-bronze-l1-dark': tailwind['amber-800'],

  'background-self-l0': 'oklch(93% 0.02 160)',
  'background-self-l1': 'oklch(91% 0.02 160)',
  'foreground-self-l0': `color-mix(in oklch, ${tailwind['emerald-700']} 80%, transparent)`,
  'foreground-self-l1': `color-mix(in oklch, ${tailwind['emerald-700']} 60%, transparent)`,
  'background-self-l0-dark': 'oklch(22% 0.015 163)',
  'background-self-l1-dark': 'oklch(26% 0.02 163)',
  'foreground-self-l0-dark': tailwind['emerald-400'],
  'foreground-self-l1-dark': tailwind['emerald-700'],

  'background-nth': 'oklch(89% 0 0)', // background-l4
  'foreground-nth-l0': 'oklch(43.9% 0 0)', // foreground-l1
  'foreground-nth-l1': 'oklch(60% 0 0)', // foreground-l3
  'background-nth-dark': 'oklch(26% 0 0)', // background-l3
  'foreground-nth-l0-dark': 'oklch(87% 0 0)', // foreground-l2
  'foreground-nth-l1-dark': 'oklch(70.8% 0 0)', // foreground-l3

  'foreground-first': tailwind['red-500'],
  'foreground-second': tailwind['amber-500'],
  'foreground-third': tailwind['lime-500'],
  'foreground-fourth': tailwind['emerald-500'],
  'foreground-fifth': tailwind['cyan-500'],
  'foreground-sixth': tailwind['sky-500'],
  'foreground-seventh': tailwind['blue-500'],
  'foreground-eighth': tailwind['violet-500'],
  'foreground-ninth': tailwind['fuchsia-500'],
  'foreground-tenth': tailwind['pink-500'],

  'foreground-first-dark': tailwind['red-300'],
  'foreground-second-dark': tailwind['amber-300'],
  'foreground-third-dark': tailwind['lime-300'],
  'foreground-fourth-dark': tailwind['emerald-300'],
  'foreground-fifth-dark': tailwind['cyan-300'],
  'foreground-sixth-dark': tailwind['sky-300'],
  'foreground-seventh-dark': tailwind['blue-300'],
  'foreground-eighth-dark': tailwind['violet-300'],
  'foreground-ninth-dark': tailwind['fuchsia-300'],
  'foreground-tenth-dark': tailwind['pink-300'],

  'background-destructive': `color-mix(in oklch, ${tailwind['red-400']} 30%, transparent)`,
  'background-destructive-hover': `color-mix(in oklch, ${tailwind['red-400']} 45%, transparent)`,
  'foreground-destructive': tailwind['red-700'],
  'background-destructive-dark': `color-mix(in oklch, ${tailwind['red-950']} 50%, transparent)`,
  ...
  'foreground-prose': 'oklch(43.9% 0 0)', // foreground-l1
  'foreground-prose-link': tailwind['sky-700'],
  'foreground-prose-inline-code': 'oklch(43.9% 0 0)', // foreground-l1
  'foreground-prose-dark': 'oklch(87% 0 0)', // foreground-l2
  'foreground-prose-link-dark': tailwind['sky-300'],
  'foreground-prose-inline-code-dark': tailwind['red-100'],

  'background-red-l0': `color-mix(in oklch, ${tailwind['red-400']} 15%, transparent)`,
  'background-red-l1': `color-mix(in oklch, ${tailwind['red-400']} 5%, transparent)`,
  'foreground-red-l0': `color-mix(in oklch, ${tailwind['red-900']} 90%, transparent)`,
  'foreground-red-l1': `color-mix(in oklch, ${tailwind['red-900']} 80%, transparent)`,

  'background-orange-l0': `color-mix(in oklch, ${tailwind['orange-400']} 15%, transparent)`,
  'background-orange-l1': `color-mix(in oklch, ${tailwind['orange-400']} 5%, transparent)`,
  'foreground-orange-l0': `color-mix(in oklch, ${tailwind['orange-900']} 90%, transparent)`,
  'foreground-orange-l1': `color-mix(in oklch, ${tailwind['orange-900']} 80%, transparent)`,

  'background-yellow-l0': `color-mix(in oklch, ${tailwind['yellow-400']} 15%, transparent)`,
  'background-yellow-l1': `color-mix(in oklch, ${tailwind['yellow-400']} 5%, transparent)`,
  'foreground-yellow-l0': `color-mix(in oklch, ${tailwind['yellow-900']} 90%, transparent)`,
  'foreground-yellow-l1': `color-mix(in oklch, ${tailwind['yellow-900']} 80%, transparent)`,

  'background-green-l0': `color-mix(in oklch, ${tailwind['green-400']} 15%, transparent)`,
  'background-green-l1': `color-mix(in oklch, ${tailwind['green-400']} 5%, transparent)`,
  'foreground-green-l0': `color-mix(in oklch, ${tailwind['green-900']} 90%, transparent)`,
  'foreground-green-l1': `color-mix(in oklch, ${tailwind['green-900']} 80%, transparent)`,

  'background-teal-l0': `color-mix(in oklch, ${tailwind['teal-400']} 15%, transparent)`,
  'background-teal-l1': `color-mix(in oklch, ${tailwind['teal-400']} 5%, transparent)`,
  'foreground-teal-l0': `color-mix(in oklch, ${tailwind['teal-900']} 90%, transparent)`,
  'foreground-teal-l1': `color-mix(in oklch, ${tailwind['teal-900']} 80%, transparent)`,

  'background-blue-l0': `color-mix(in oklch, ${tailwind['sky-400']} 15%, transparent)`,
  'background-blue-l1': `color-mix(in oklch, ${tailwind['sky-400']} 5%, transparent)`,
  'foreground-blue-l0': `color-mix(in oklch, ${tailwind['sky-900']} 90%, transparent)`,
  'foreground-blue-l1': `color-mix(in oklch, ${tailwind['sky-900']} 80%, transparent)`,

  'background-purple-l0': `color-mix(in oklch, ${tailwind['purple-400']} 15%, transparent)`,
  'background-purple-l1': `color-mix(in oklch, ${tailwind['purple-400']} 5%, transparent)`,
  'foreground-purple-l0': `color-mix(in oklch, ${tailwind['purple-900']} 90%, transparent)`,
  'foreground-purple-l1': `color-mix(in oklch, ${tailwind['purple-900']} 80%, transparent)`,

  'background-pink-l0': `color-mix(in oklch, ${tailwind['pink-400']} 15%, transparent)`,
  'background-pink-l1': `color-mix(in oklch, ${tailwind['pink-400']} 5%, transparent)`,
  'foreground-pink-l0': `color-mix(in oklch, ${tailwind['pink-900']} 90%, transparent)`,
  'foreground-pink-l1': `color-mix(in oklch, ${tailwind['pink-900']} 80%, transparent)`,

  'background-fuchsia-l0': `color-mix(in oklch, ${tailwind['fuchsia-400']} 15%, transparent)`,
  'background-fuchsia-l1': `color-mix(in oklch, ${tailwind['fuchsia-400']} 5%, transparent)`,
  'foreground-fuchsia-l0': `color-mix(in oklch, ${tailwind['fuchsia-900']} 90%, transparent)`,
  'foreground-fuchsia-l1': `color-mix(in oklch, ${tailwind['fuchsia-900']} 80%, transparent)`,

  'background-gray-l0': `color-mix(in oklch, ${tailwind['gray-400']} 15%, transparent)`,
  'background-gray-l1': `color-mix(in oklch, ${tailwind['gray-400']} 5%, transparent)`,
  'foreground-gray-l0': `color-mix(in oklch, ${tailwind['gray-900']} 90%, transparent)`,
  'foreground-gray-l1': `color-mix(in oklch, ${tailwind['gray-900']} 80%, transparent)`,
}
...
const lightBg = 'oklch(98% 0 0)'
const darkBg = 'oklch(15% 0 0)'

export default function Swatch({ color, label, mode = 'light' }: SwatchProps) {
  const fg = colors[color] || color
  const baseBg = mode === 'dark' ? darkBg : lightBg
  ...
  return (
    <span
      style={{
        ...
        width: 'fit-content',
        backgroundColor: 'var(--vocs-color_codeInlineBackground)',
      }}
    >
      <span
        style={{
      ...
      {label && (
        <code
          style={{
            ...
            fontSize: 'var(--vocs-fontSize_code)',
