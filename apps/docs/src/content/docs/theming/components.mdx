  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        destructive: "bg-background-destructive text-foreground-destructive hover:bg-background-destructive-hover focus-visible:ring-foreground-destructive/20 border-foreground-destructive/50",
