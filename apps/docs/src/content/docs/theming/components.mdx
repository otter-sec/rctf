...
| --- | --- | --- | --- | --- |
| `--background{:css}` | `bg-background-l0{:css}` | <Swatch color="background-l0" /> | <Swatch color="background-l0-dark" mode="dark" /> | Page background |
| `--foreground{:css}` | `text-foreground-l0{:css}` | <Swatch color="foreground-l0" /> | <Swatch color="foreground-l0-dark" mode="dark" /> | Primary body text |
| `--card{:css}` | `bg-background-l1{:css}` | <Swatch color="background-l1" /> | <Swatch color="background-l1-dark" mode="dark" /> | Card surfaces |
| `--card-foreground{:css}` | `text-foreground-l0{:css}` | <Swatch color="foreground-l0" /> | <Swatch color="foreground-l0-dark" mode="dark" /> | Card text |
| `--popover{:css}` | `bg-background-l1{:css}` | <Swatch color="background-l1" /> | <Swatch color="background-l1-dark" mode="dark" /> | Dropdowns, popovers |
| `--popover-foreground{:css}` | `text-foreground-l0{:css}` | <Swatch color="foreground-l0" /> | <Swatch color="foreground-l0-dark" mode="dark" /> | Text in overlays |
| `--primary{:css}` | `bg-background-accent{:css}` | <Swatch color="background-accent" /> | <Swatch color="background-accent-dark" mode="dark" /> | Accent buttons, badges |
| `--primary-foreground{:css}` | `text-foreground-accent{:css}` | <Swatch color="foreground-accent" /> | <Swatch color="foreground-accent-dark" mode="dark" /> | Text on accent backgrounds/accent-colored text |
| `--secondary{:css}` | `bg-background-l4{:css}` | <Swatch color="background-l4" /> | <Swatch color="background-l4-dark" mode="dark" /> | Secondary buttons, badges |
| `--secondary-foreground{:css}` | `text-foreground-l1{:css}` | <Swatch color="foreground-l1" /> | <Swatch color="foreground-l1-dark" mode="dark" /> | Text on secondary backgrounds |
| `--muted{:css}` | `bg-background-l2{:css}` | <Swatch color="background-l2" /> | <Swatch color="background-l2-dark" mode="dark" /> | Subtle backgrounds |
| `--muted-foreground{:css}` | `text-foreground-l3{:css}` | <Swatch color="foreground-l3" /> | <Swatch color="foreground-l3-dark" mode="dark" /> | Placeholders, hints |
| `--accent{:css}` | `bg-background-l2{:css}` | <Swatch color="background-l2" /> | <Swatch color="background-l2-dark" mode="dark" /> | Hover states, highlights, generic hover |
| `--accent-foreground{:css}` | `text-foreground-l0{:css}` | <Swatch color="foreground-l0" /> | <Swatch color="foreground-l0-dark" mode="dark" /> | Text on hover backgrounds |
| `--destructive{:css}` | `bg-background-destructive{:css}` | <Swatch color="background-destructive" /> | <Swatch color="background-destructive-dark" mode="dark" /> | Error states |
| `--input{:css}` | `bg-background-l4{:css}` | <Swatch color="background-l4" /> | <Swatch color="background-l4-dark" mode="dark" /> | Form inputs |
