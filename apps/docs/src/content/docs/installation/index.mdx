...
For production, plan on a VPS with at least 2 CPU cores and 4 GiB RAM. The [Setting Up a CTF Platform](/meta/running-a-successful-ctf/03-setup/) guide walks through the full deployment, including Nginx, TLS, and firewall configuration.
