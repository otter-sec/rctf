...
| [Instancer](/integrations/instancer/) | `<red>instancers</red>` | `<green>instancer/docker-instancer</green>`, `<green>instancer/k8s-instancer</green>`, `<green>instancer/paradigmctf-instancer</green>` | None (disabled) |
