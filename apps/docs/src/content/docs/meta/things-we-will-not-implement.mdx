...
<Steps>
<Step title="First blood bonus points">
...
<Step title="Limited flag submission attempts">
...
<Step title="Requiring authentication to see challenges or leaderboard">
