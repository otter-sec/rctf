...
The notes are split across three pages. This page covers planning and onsite issues; the rest live in [Infrastructure](/meta/running-a-successful-ctf/07-common-mistakes/infrastructure/) and [Challenges](/meta/running-a-successful-ctf/07-common-mistakes/challenges/).
