---
title: Meta
description: Notes on running events with rCTF and on the project's scope.
order: 9
---
...
::::card-grid
:::card[Running a successful CTF]{href=/docs/meta/running-a-successful-ctf}
A practical playbook: prerequisites, challenge design, setup, deployment, the event itself, and the aftermath.
:::
:::card[Things we will not implement]{href=/docs/meta/things-we-will-not-implement}
