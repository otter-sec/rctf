...
<Callout variant='note' title='No production-ready manifests yet'>
  ...
  fleet - the queue-depth endpoint exists, but wiring it to KEDA/HPA and a scrape job is left to
  the deployer for now. If you build one and want to upstream it, see the note at the top of this
  page.
</Callout>
