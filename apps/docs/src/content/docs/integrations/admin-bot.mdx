...
The admin challenge editor sends the TypeScript source to the browser worker's `[2m/[22mv1[2m/[22mtest{:ansi}` endpoint. The worker builds the source, validates the exported `Challenge{:ts}`, returns the public input schema, and lets the API store a config revision.
...
```ansi
$ [31mdocker[0m compose [02m-f[0m deploy/admin-bot/compose.yml up [02m-d[0m
```
...
<Callout variant="warning" title="Network exposure">
  Keep the worker reachable only from trusted infrastructure. The `[2m/[22mv1[2m/[22mtest{:ansi}` endpoint is bearer-authenticated, but it still builds trusted challenge source. The worker should not be exposed as a public internet service.
</Callout>
...
By default, Chrome starts with `[02m--no-sandbox[0m{:ansi}`, `[02m--disable-jit[0m{:ansi}`, `[02m--disable-wasm[0m{:ansi}`, and `[02m--disable-dev-shm-usage[0m{:ansi}`. Firefox starts with JIT and Wasm disabled through preferences. Replacing `browserArguments{:ts}` or `extraPrefsFirefox{:ts}` removes those defaults.
...
| Method | Path | Purpose |
| --- | --- | --- |
| `[36mGET[0m{:ansi}` | `[2m/api/[22mv2[2m/[22mintegrations[2m/[22mchalls[2m/[22m:id[2m/[22madmin-bot[2m/[22mconfig{:ansi}` | Returns source code and file extension for the released challenge config. |
| `[32mPOST[0m{:ansi}` | `[2m/api/[22mv2[2m/[22mintegrations[2m/[22mchalls[2m/[22m:id[2m/[22madmin-bot{:ansi}` | Validates inputs and queues a job. |
| `[36mGET[0m{:ansi}` | `[2m/api/[22mv2[2m/[22mintegrations[2m/[22mchalls[2m/[22m:id[2m/[22madmin-bot[2m/[22mstatus{:ansi}` | Returns the latest job, logs when present, and queue position while queued. |
| `[36mGET[0m{:ansi}` | `[2m/api/[22mv2[2m/[22mintegrations[2m/[22mchalls[2m/[22m:id[2m/[22madmin-bot[2m/[22mhistory{:ansi}` | Returns completed and failed jobs retained for the current user. |
| `[36mGET[0m{:ansi}` | `[2m/api/[22mv2[2m/[22mintegrations[2m/[22mchalls[2m/[22m:id[2m/[22madmin-bot[2m/[22mjobs[2m/[22m:jobId[2m/[22mlogs{:ansi}` | Returns stored logs for one retained job. |
...
| Method | Path | Purpose |
| --- | --- | --- |
| `[32mPOST[0m{:ansi}` | `[2m/api/[22mv2[2m/[22madmin[2m/[22madmin-bot[2m/[22mjobs[2m/[22mpull{:ansi}` | Claims the oldest queued job. |
| `[36mGET[0m{:ansi}` | `[2m/api/[22mv2[2m/[22madmin[2m/[22madmin-bot[2m/[22mchallenges[2m/[22m:id[2m/[22msource{:ansi}` | Fetches challenge source for the claimed revision. |
| `[32mPOST[0m{:ansi}` | `[2m/api/[22mv2[2m/[22madmin[2m/[22madmin-bot[2m/[22mjobs[2m/[22m:id[2m/[22mcomplete{:ansi}` | Marks a running job as completed and stores logs. |
| `[32mPOST[0m{:ansi}` | `[2m/api/[22mv2[2m/[22madmin[2m/[22madmin-bot[2m/[22mjobs[2m/[22m:id[2m/[22mfail{:ansi}` | Marks a running job as failed and stores logs. |
| `[36mGET[0m{:ansi}` | `[2m/api/[22mv2[2m/[22madmin[2m/[22madmin-bot[2m/[22mqueue-depth{:ansi}` | Returns the number of queued jobs. |
