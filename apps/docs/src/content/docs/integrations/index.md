...
| [Instancer](/integrations/instancer) | `<red>instancerProvider</red>` | Per-team challenge instance management via Docker or Kubernetes. Isolated environments per team with configurable timeouts, manual extension, and automatic cleanup. |
