...
<RouteAside>
  <RouteExample def={GetAdminBotChallengeSourceRouteV2} params={{ id: 'challenge-id' }} />
</RouteAside>
...
<RequestBody def={GetAdminBotChallengeSourceRouteV2} source="params" title="Path parameters" />
