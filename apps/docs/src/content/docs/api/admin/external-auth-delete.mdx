...
<RouteAside>
  <RouteExample
    def={DeleteExternalAuthClientRouteV2}
    params={{ id: '11111111-2222-3333-4444-555555555555' }}
  />
</RouteAside>

<RouteMetaFromDef def={DeleteExternalAuthClientRouteV2} />
...
<RequestBody def={DeleteExternalAuthClientRouteV2} source="params" title="Path parameters" />
