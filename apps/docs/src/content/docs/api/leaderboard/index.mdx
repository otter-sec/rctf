...
<RouteAside>
  <RouteList>
    <RouteListItem
      ...
      method="GET"
      path="/api/[v2,v1]/leaderboard/now"
      href="/api/leaderboard/now/"
    />
    <RouteListItem
      title="Standings with graph"
      method="GET"
      path="/api/v2/leaderboard/with-graph"
      href="/api/leaderboard/with-graph/"
    />
    <RouteListItem
      title="Score graph"
      method="GET"
      path="/api/[v2,v1]/leaderboard/graph"
      href="/api/leaderboard/graph/"
    />
    <RouteListItem
      title="Leaderboard challenges"
      method="GET"
      path="/api/v2/leaderboard/challs"
      href="/api/leaderboard/challs/"
    />
  </RouteList>
</RouteAside>
