...
4. **Install and configure Nginx**
   ...
   ```nginx title="/etc/nginx/sites-available/rctf.conf" showLineNumbers
   # Redirect HTTP -> HTTPS
   server {
       listen 80;
       server_name ctf.example.com; # TODO: update me to CTF platform domain name // [!code highlight]
...
2. **Install and configure Nginx**
   ...
   server {
       listen 443 ssl;
       server_name ctf.example.com; # TODO: update me to CTF platform domain name // [!code highlight]
       ssl_certificate /etc/letsencrypt/live/ctf.example.com/fullchain.pem; # TODO: update path to CTF platform domain name // [!code highlight]
       ssl_certificate_key /etc/letsencrypt/live/ctf.example.com/privkey.pem; # TODO: update path to CTF platform domain name // [!code highlight]
