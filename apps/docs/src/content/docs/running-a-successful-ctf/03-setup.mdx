...
Every time you update the configuration, run `nginx -t && nginx -s reload` to validate and apply changes. After all these steps, you should be able to visit `https://ctf.example.com` and view rCTF!
