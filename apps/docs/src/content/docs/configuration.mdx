...
| `<red>instancers</red>` | `object{:ts}` | - | Named challenge instancer providers (optional) |
| `<red>defaultInstancer</red>` | `string{:ts}` | - | Instancer challenges use unless they set their own (optional) |
