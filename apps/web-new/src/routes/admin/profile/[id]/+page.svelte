...
<script lang="ts">
  ...
  import { toChallengeInfos } from '../../../profile/profile-analytics-data'
  import ProfileAnalytics from '../../../profile/profile-analytics.svelte'
  import type { GraphSampleInput } from '../../../profile/profile-graph-data'
  import ProfileHeader from '../../../profile/profile-header.svelte'
  import ProfileShell from '../../../profile/profile-shell.svelte'
  ...
  <ProfileShell {tabs} desktopColumn="settings" {status}>
    {#snippet unavailable()}
      <Card title="Team not found">
        <p>{userQuery.error?.message ?? 'The requested team could not be found.'}</p>
