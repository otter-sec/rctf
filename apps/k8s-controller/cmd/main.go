...
func init() {
	...
	utilruntime.Must(rctfinstancerv1.AddToScheme(scheme))
...
func main() {
	...
	if instancerHost == "" {
		setupLog.Error(errors.New("the -instancer-host argument is not provided"), "unable to start")
		os.Exit(1)
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "rctf-controller-leader-election.osec.io",
